...
# sf2 - modified from the original SWORD code since guess_doc_type has a different function in EPrints 3.3
# since it seems that only XML and ZIP are requested/useful I've hard-coded the two mime-types:
